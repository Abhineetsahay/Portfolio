  ...
  return (
    ...
    >
      ...
      >
        {items.map((item, idx) => (
          <li
            className="relative w-[300px] max-w-full shrink-0 rounded-2xl border border-gray-700 bg-gradient-to-b from-zinc-900 to-zinc-800 px-6 py-5 md:w-[400px] shadow-lg"
            key={item.name}
          >
            <blockquote>
              <div
