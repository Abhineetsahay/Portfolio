  ...
  return (
    ...
    >
      ...
      >
        {items.map((item, idx) => (
          <li
            className="relative w-[300px] max-w-full shrink-0 rounded-2xl border border-gray-700 bg-gradient-to-b from-zinc-900 to-zinc-800 px-6 py-5 md:w-[400px] shadow-lg hover:border-x-blue-700"
            key={item.name}
          >
            <blockquote>
              <div
              ...
              <span className="relative z-20 text-sm leading-[1.6] font-normal text-white">
                {React.isValidElement(item.quote) ? (
                  ...
                  <span className="text-red-500">Invalid quote element</span>
                )}
              </span>
